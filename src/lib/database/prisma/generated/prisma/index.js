...
const config = {
	generator: {
		...
		previewFeatures: [],
		sourceFilePath:
			"C:\\Users\\Erivaldo\\www\\step-cash\\prisma\\schema.prisma",
		isCustomOutput: true,
	},
	relativeEnvPaths: {
		rootEnvPath: null,
	...
	inlineSchemaHash:
		"f9498c670dc761a6a08d72d2b4c1aad10d6cdffbf11a7f0782d483fff3337af2",
	copyEngine: true,
};
...
path.join(
	process.cwd(),
	"src/lib/database/prisma/generated/prisma/query_engine-windows.dll.node",
);
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(
	process.cwd(),
	"src/lib/database/prisma/generated/prisma/schema.prisma",
);
