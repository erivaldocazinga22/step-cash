...
export default async function OneChallengePage(props: {
		...
		<main className="flex-1 p-6">
			<div className="max-w-7xl mx-auto">
				...
				<Card className="mb-8">
					<CardHeader>
						<CardTitle>
							Valores Sugeridos para Alcançar a Meta
						</CardTitle>
						<CardDescription>
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Marque seus investimentos diários para acompanhar o
							progresso
						</CardDescription>
					</CardHeader>
					<CardContent>
